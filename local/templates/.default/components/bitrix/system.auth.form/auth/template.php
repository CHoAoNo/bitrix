...
<?endforeach?>
	...
	<input placeholder="<?=GetMessage("AUTH_LOGIN")?>" name="USER_LOGIN" maxlength="50" value="" type="text">
...
<span class="hd_sing">
<a href="<?=$arResult["PROFILE_URL"]?>"><?=$arResult["USER_NAME"]?></a> [<?=$arResult["USER_LOGIN"]?>]
</span>
